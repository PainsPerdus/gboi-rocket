...
Vi and Pascal quickly made a pull request with a display module. Now we can see Isaac on the screen, and a stub allow the buttons to update the isaac variable so we can move it.
